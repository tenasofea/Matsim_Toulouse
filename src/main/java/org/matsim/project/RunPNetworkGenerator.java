...
public class RunPNetworkGenerator {
	...
	public static void main(String[] args) {
		 ...
		 * The input file name.
		 */
		String osm = "C:\\Users\\User\\IdeaProjects\\matsim-example-project-modified\\scenarios\\equil\\merged-network.osm";
		 ...
		 */
		new NetworkWriter(network).write("C:\\Users\\User\\IdeaProjects\\matsim-example-project-modified\\scenarios\\equil\\network-belfort.xml");
